...
<@mainLayout header="">
    <#if project??>
    <form action="/project/update/${project.id}" method="post" enctype="multipart/form-data" id="edit_project">
        <div class="shadow">
            <div id="one_group_header_img" style="width: 980px; height: 150px; overflow: hidden;">
                <#if project.avatarUrl??>
                    <div style="width: 980px; height: 150px; overflow: hidden;">
                        <img src="<@spring.url '/uploads/Project_Avatar/${project.avatarUrl}'/>"
                             id="one_group_main_img">
                    </div>
                <#else>
                    <img src="<@spring.url '/images/wide_ph.png'/>" id="one_group_main_img">
                </#if>
            ...
            <div class="flex_row flex_justify_space_between flexbox_aling_center" id="one_group_header">
                ...
                <div class="font_one_page_header">
                    <span class="edit_block">${project.projectName}</span>
            ...
            <#--</div>-->
                ...
                <div class="flex_row">
                    ...
                    <#if isSubscribed!=true>
                        <button onclick="location.href='/project/${project.id}/subscribe'" type="button"
                                class="event_button one_group_header_button button_effect font_button_checkbox_radio edit_block">
                            Вступить
                        </button>
                    <#else>
                        <button onclick="location.href='/project/${project.id}/unsubscribe'" type="button"
                                class="event_button one_group_header_button button_effect font_button_checkbox_radio edit_block">
                            Выйти
                        </button>
                    </#if>
        ...
        <div class="flex_justify_space_between">
            <div>
                ...
                <div id="project_news">
                    ...
                    <#if project.news?? && project.news?size gt 0>
                        <#list project.news as ev>
                            <div class="event_block border_radius_none" id="pr_news_${ev.id}">
                                <div id="event_header" class=" flex_row flex_justify_space_between">
                                    ...
                                    <div class="hide_block">
                                        <button type="button" class="close" style="display: block; right: 0px;"
                                                onclick="deleteNews(${project.id},${ev.id})">
                                ...
                                <div>
                                    ...
                                    <#--Краткое описание новости. Краткое описание новости. Краткое описание новости.-->
                                    <#--Краткое-->
                                    <#--описание новости. Краткое описание новости. Краткое описание новости. Краткое-->
                                    <#--описание-->
                ...
                <div id="project_events">
                    <#if project.events?? && project.events?size gt 0>
                        <#list project.events as ev>
                            <div class="event_block border_radius_none" id="pr_ev_${ev.id}">
                                <div id="event_header" class=" flex_row flex_justify_space_between">
                                    ...
                                    <div class="hide_block">
                                        <button type="button" class="close" style="display: block; right: 0px;"
                                                onclick="deleteEvent(${project.id},${ev.id})">
                                            <img src="<@spring.url '/images/Modals_exit_button.png'/>" alt="img"
                                                 style="margin-right: 5px;"/>
                                        </button>
                                    </div>
                            ...
                            <span id="font_event_time">${ev.getStartedTime()}
                            </span>
                                        <span>
                                <data class="font_event_data">${ev.getStartedDate()}</data>
                                <div class="font_event_data"><#if ev.address??>${ev.address}</#if></div>
                            </span>
                                    </div>
                                    <div class="flex_row">
                                        <div id="font_event_participants">
                                            <span id="event_user_counter${ev.id}">${ev.getUsersCount()}</span>
                                        </div>
            ...
            <aside>
                ...
                <div class="shadow one_group_right_block">
                    ...
                    <hr>
                    <#if project.admins?? && project.admins?size gt 0>
                        <#list project.admins as adm>
                            <a href="#"
...
<script src="<@spring.url '/js/project.js'/>"></script>
