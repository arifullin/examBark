...
<form action="<@spring.url '/teacher/profile'/>" method="post" enctype="multipart/form-data">
    <!-- Modal -->
            ...
            <div class="modal-content" style="height: auto!important;">
                <div class="modal-header flex_column">
                    <div class="flex_row flex_justify_space_between">
                        ...
                        <div class="flex_row flexbox_aling_center">
                            <p class="font_modal_header" style="margin-right: 10px;">Преподаватель</p>
                        ...
                        <div class="flex_column" style="width: 450px;">
                            <div class="hide_block">
                                <div class="form-group">
                                    ...
                                    <input class="modal_input_block font_placeholder_student_search" id="position" required  type="text" value="${lesson}" name="position" placeholder="Например, физика">
                                </div>
                                <div>
