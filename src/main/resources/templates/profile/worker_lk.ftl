...
<@mainLayout header="Worker Profile">
    ...
    <div>
        ...
        <div class="personal_area_block font_worker_search_students_and_groups_header margin_top20px margin_bottom20px">
            <a role="button" data-toggle="collapse" href="#students_search" aria-expanded="false"
               aria-controls="collapseExample">
                <div class="flexbox_aling_center white_background_color shadow flex_justify_space_between search_cursor_header">
            ...
            <div class="well">
                ...
                <div class="hood white_background_color shadow">
                    <div class="flex_row flex_justify_space_between">
                        ...
                        <div class="font_placeholder_student_search">
                            <div class="styled-select">
                                <select id="group" class="input_block">
                                    <option>all</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="collapse" id="advanced_search" style="margin-top: 8px;">
                            <div class="well flex_row white_background_color" style="height: 170px;">
                                <div class="flex_column">
                                    ...
                                    <div class="flex_row font_button_checkbox_radio" style="padding-bottom: 10px;">
...
<#-- Showing create user modal -->
    ...
    <#-- Showing notifications -->
        <#include "modals/worker_profile_edit.ftl">
                        ...
                        <div id="wrapper${cert.user.id}">
                            <div class="blue_background_rgba_color padding10px margin_bottom20px">
                                ...
                                <p class="font_notification_text">
                                    Количество: ${cert.count}
                                </p>
                <span class="font_notification_subject_and_data">
                Студент ${cert.user.group.course} курса, ${cert.user.group.num} группы:
                    <br> ${cert.user.name} ${cert.user.surname} <#if cert.user.patronymic??>${cert.user.patronymic}</#if>
                </span>
                                <button class="mini_button_notification font_student_search_button"
                                        style="margin-right: 10px;"
                                        type="button" id="certificateDone" onclick="certificateDone(${cert.user.id})">
                                    Готово
                                </button>
                            </div>
                        </div>
...
<script type="text/javascript" src="<@spring.url '/js/certificate_notification_done.js'/>"></script>
